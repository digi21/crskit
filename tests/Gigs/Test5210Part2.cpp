...
namespace
{
	...
	const char* kMt_Test5210_part_2_MathTransform = R"WKT(INVERSE_MT[PARAM_MT["vertical_offset",PARAMETER["vertical_offset",28]]])WKT";
}

TEST(Test5210Part2, Test5210_part_2_Epsg)
{
...
TEST(Test5210Part2, Test5210_part_2_WktEpsg)
{
	const char* kSource = R"WKT(VERT_CS["Caspian height",VERT_DATUM["Caspian Sea",2005,AUTHORITY["EPSG","5106"]],UNIT["metre",1,AUTHORITY["EPSG","9001"]],AXIS["H", Up],AUTHORITY["EPSG","5611"]])WKT";
...
TEST(Test5210Part2, Test5210_part_2_MathTransform)
{
	ExecuteTests(GetMathTransformFactory()->CreateFromWkt(kMt_Test5210_part_2_MathTransform));
}
