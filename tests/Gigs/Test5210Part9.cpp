...
namespace
{
	...
	const char* kMt_Test5210_part_9_MathTransform = R"WKT(CONCAT_MT[PARAM_MT["Affine", PARAMETER["num_row",2], PARAMETER["num_col", 2],PARAMETER["elt_0_0", -1],PARAMETER["elt_0_1", 0],PARAMETER["elt_1_0", 0],PARAMETER["elt_1_1", -1]]])WKT";
}

TEST(Test5210Part9, Test5210_part_9_Epsg)
{
...
TEST(Test5210Part9, Test5210_part_9_WktEpsg)
{
...
TEST(Test5210Part9, Test5210_part_9_MathTransform)
{
	ExecuteTests(GetMathTransformFactory()->CreateFromWkt(kMt_Test5210_part_9_MathTransform));
}
